var progress4 = {
    ...
    progressfour: function () {
        var myChart = echarts.init(document.getElementById('progressfour'));
        var datas =[];
        var header =[];
        ...
        $.ajax({
            ...
            data: {startTime:firstDay.getTime() , endTime: lastDay.getTime(),addressCode:defaultAddressCode,continentId:2},
            dataType: "json",
